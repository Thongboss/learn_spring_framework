...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C007420" ON "LN_AUTHORITIES" ("ID") 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C007422" ON "LN_CATEGORIES" ("CATEGORY_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C007426" ON "LN_ORDERDETAILS" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C007428" ON "LN_ORDERS" ("ORDER_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C007431" ON "LN_POSTS" ("POST_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C007434" ON "LN_PRODUCTS" ("PRODUCT_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C007436" ON "LN_ROLES" ("ROLE_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYS_C007438" ON "LN_USERS" ("USER_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM"  ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table LN_AUTHORITIES
--------------------------------------------------------

  ALTER TABLE "LN_AUTHORITIES" ADD CONSTRAINT "FK2KCUL1SKEGYO3GKMTB58EI5VS" FOREIGN KEY ("ROLE_ID")
	  REFERENCES "LN_ROLES" ("ROLE_ID") ENABLE;
  ALTER TABLE "LN_AUTHORITIES" ADD CONSTRAINT "FK7W3JSTY5VR8SHWY5MFCGVUQ1B" FOREIGN KEY ("USER_ID")
	  REFERENCES "LN_USERS" ("USER_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table LN_ORDERDETAILS
--------------------------------------------------------

  ALTER TABLE "LN_ORDERDETAILS" ADD CONSTRAINT "FK2RJELLKFPIJ7G047J54LEIQCL" FOREIGN KEY ("ORDER_ID")
	  REFERENCES "LN_ORDERS" ("ORDER_ID") ENABLE;
  ALTER TABLE "LN_ORDERDETAILS" ADD CONSTRAINT "FKTIDKUKGB1UD1WAVVNHSP00RNW" FOREIGN KEY ("PRODUCT_ID")
	  REFERENCES "LN_PRODUCTS" ("PRODUCT_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table LN_ORDERS
--------------------------------------------------------

  ALTER TABLE "LN_ORDERS" ADD CONSTRAINT "FKLE0MKL13J2TG7K7B490IEACDJ" FOREIGN KEY ("USER_ID")
	  REFERENCES "LN_USERS" ("USER_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table LN_POSTS
--------------------------------------------------------

  ALTER TABLE "LN_POSTS" ADD CONSTRAINT "FKHAH8SGB6U1VEK8CIKE33U89BH" FOREIGN KEY ("USER_ID")
	  REFERENCES "LN_USERS" ("USER_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table LN_PRODUCTS
--------------------------------------------------------

  ALTER TABLE "LN_PRODUCTS" ADD CONSTRAINT "FKQVUKMIKV4463X8XF01C0E12LJ" FOREIGN KEY ("CATEGORY_ID")
	  REFERENCES "LN_CATEGORIES" ("CATEGORY_ID") ENABLE;
