...
--------------------------------------------------------
  ...
  CREATE TABLE "LN_AUTHORITIES" ("ID" NUMBER(19,0) GENERATED ALWAYS AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , "ROLE_ID" NUMBER(19,0), "USER_ID" NUMBER(19,0))
--------------------------------------------------------
--  DDL for Table LN_CATEGORIES
--------------------------------------------------------

  CREATE TABLE "LN_CATEGORIES" ("CATEGORY_ID" NUMBER(19,0) GENERATED ALWAYS AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , "CATEGORY_NAME" VARCHAR2(255 CHAR))
--------------------------------------------------------
--  DDL for Table LN_ORDERDETAILS
--------------------------------------------------------

  CREATE TABLE "LN_ORDERDETAILS" ("ID" NUMBER(19,0) GENERATED ALWAYS AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , "PRICE" FLOAT(53), "QUANTITY" NUMBER(10,0), "ORDER_ID" NUMBER(19,0), "PRODUCT_ID" NUMBER(19,0))
--------------------------------------------------------
--  DDL for Table LN_ORDERS
--------------------------------------------------------

  CREATE TABLE "LN_ORDERS" ("ORDER_ID" NUMBER(19,0) GENERATED ALWAYS AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , "ADDRESS" VARCHAR2(255 CHAR), "CODE_ORDER" VARCHAR2(255 CHAR), "CREATE_ORDER" DATE, "USER_ID" NUMBER(19,0), "DESCRIBE" VARCHAR2(255 CHAR))
--------------------------------------------------------
--  DDL for Table LN_POSTS
--------------------------------------------------------

  CREATE TABLE "LN_POSTS" ("POST_ID" NUMBER(19,0) GENERATED ALWAYS AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , "CONTENT" VARCHAR2(255 CHAR), "CREATE_POST" VARCHAR2(255 CHAR), "STARS" NUMBER(10,0), "USER_ID" NUMBER(19,0))
--------------------------------------------------------
--  DDL for Table LN_PRODUCTS
--------------------------------------------------------

  CREATE TABLE "LN_PRODUCTS" ("PRODUCT_ID" NUMBER(19,0) GENERATED ALWAYS AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , "CREATE_DATE" VARCHAR2(255 CHAR), "PRICE" FLOAT(53), "PRODUCT_NAME" VARCHAR2(255 CHAR), "QUANTITY" NUMBER(19,0), "CATEGORY_ID" NUMBER(19,0), "IMAGES" VARCHAR2(255 CHAR), "DESCRIBE" VARCHAR2(255 CHAR))
--------------------------------------------------------
--  DDL for Table LN_ROLES
--------------------------------------------------------

  CREATE TABLE "LN_ROLES" ("ROLE_ID" NUMBER(19,0) GENERATED ALWAYS AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , "ROLE_NAME" VARCHAR2(255 CHAR))
--------------------------------------------------------
--  DDL for Table LN_USERS
--------------------------------------------------------

  CREATE TABLE "LN_USERS" ("USER_ID" NUMBER(19,0) GENERATED ALWAYS AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , "DATE_CREATE" VARCHAR2(255 CHAR), "EMAIL" VARCHAR2(255 CHAR), "PASSWORD" VARCHAR2(255 CHAR), "PHONE" VARCHAR2(255 CHAR), "PHOTO" VARCHAR2(255 CHAR), "USER_NAME" VARCHAR2(255 CHAR))
...
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (3,'2020-12-24 13:20',3400,'?o?n ?ao Navori',2500,10,'https://izgaming.com/wp-content/uploads/2020/12/doan-dao-navori.png','Ch? S? C? B?n: S?c m?nh công kích: 60, T? l? chí m?ng: 20%, ?i?m h?i k? n?ng: 30');
...
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (5,'2020-12-24 13:20',2900,'Giáp Thiên Nhiên',2500,10,'https://izgaming.com/wp-content/uploads/2021/01/giap-thien-nhien.jpg','Ch? S? C? B?n: Máu: 350, Kháng phép: 60, T?c ?? di chuy?n: 5%');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (6,'2020-12-24 13:20',2800,'Ki?m Ác Xà',2500,10,'https://izgaming.com/wp-content/uploads/2021/01/Serpents-Fang.jpg','Ch? S? C? B?n: S?c m?nh công kích: 60, Sát l?c: 18');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (7,'2020-12-24 13:20',3000,'Kính Nh?m Ma Pháp',2500,10,'https://izgaming.com/wp-content/uploads/2020/11/kinh-nham-ma-phap.png','Ch? S? C? B?n: S?c m?nh phép thu?t: 100');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (8,'2020-12-24 13:20',3000,'??ng C? V? Tr?',2500,10,'https://izgaming.com/wp-content/uploads/2021/01/dong-co-vu-tru.jpg','Ch? S? C? B?n: S?c m?nh phép thu?t: 70, Máu: 200, ?i?m h?i k? n?ng: 30');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (9,'2020-12-24 13:20',3000,'M? Tr? Nguy?n R?a',2500,10,'https://izgaming.com/wp-content/uploads/2020/11/mu-tru-nguyen-rua.png','Ch? S? C? B?n: S?c m?nh phép thu?t: 70, Máu: 350');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (10,'2020-12-24 13:20',3400,'Th??ng Ph?c H?n Serylda',2500,10,'https://izgaming.com/wp-content/uploads/2020/11/thuong-phuc-han-sheryldy.png','Ch? S? C? B?n: S?c m?nh công kích: 45, Xuyên giáp: 30%, ?i?m h?i k? n?ng: 20');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (11,'2020-12-24 13:20',3000,'Chùy B?ch Ngân',2500,10,'https://izgaming.com/wp-content/uploads/2021/01/silvermere-Dawn.jpg','Ch? S? C? B?n: S?c m?nh công kích: 35, Máu: 200, Kháng phép: 35');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (12,'2020-12-24 13:20',2700,'C?a Xích Hóa K?',2500,10,'https://izgaming.com/wp-content/uploads/2020/11/cua-xich-hoa-ky.png','Ch? S? C? B?n: S?c m?nh công kích: 45, Máu: 200, ?i?m h?i k? n?ng: 15');
...
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (141,'2020-12-24 13:20',3200,'L??i hái bóng ?êm',2500,9,'https://izgaming.com/wp-content/uploads/2020/11/luoi-hai-bong-dem.jpg','Thu?c tính: Sát th??ng k? n?ng: +80., Máu: +250., ?i?m h?i k? n?ng: +15.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (142,'2020-12-24 13:20',3400,'M?t N? Th?ng Kh? Liandry',2500,9,'https://izgaming.com/wp-content/uploads/2020/11/mat-na-thong-kho-liandry.jpg','Thu?c tính: Sát th??ng phép: +80., Mana: + 600., ?i?m h?i k? n?ng: +20.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (143,'2020-12-24 13:20',3400,'Móc Di?t Th?y Quái',2500,9,'https://izgaming.com/wp-content/uploads/2020/11/moc-thuy-quai.jpg','Thu?c tính: Sát th??ng v?t lý: + 60., T?c ?ánh: + 25%., T? l? chí m?ng: + 20%.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (144,'2020-12-24 13:20',3200,'Móng Vu?t Ám Mu?i',2500,9,'https://izgaming.com/wp-content/uploads/2020/11/mong-vuot-am-muoi.jpg','Thu?c tính: Sát th??ng v?t lý: +55., ?i?m xuyên giáp: +18., ?i?m h?i k? n?ng: +10');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (145,'2020-12-24 13:20',3200,'Nguy?t ?ao',2500,9,'https://izgaming.com/wp-content/uploads/2020/11/nguyet-dao.jpg','Thu?c tính: Sát th??ng v?t lý : +55., ?i?m xuyên giáp: +18., Hút máu toàn ph?n: +10%.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (146,'2020-12-24 13:20',3400,'N? T? Th?',2500,9,'https://izgaming.com/wp-content/uploads/2020/11/no-tu-thu.jpg','Thu?c tính: Sát th??ng v?t lý: +50., T?c ?ánh: + 15%., T? l? chí m?ng: +20%., Hút máu: +12%.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (147,'2020-12-24 13:20',3200,'Quy?n Tr??ng Ác Th?n',2500,9,'https://izgaming.com/wp-content/uploads/2020/11/quyen-truong-ac-than.jpg','Thu?c tính: Sát th??ng k? n?ng: +80., Máu: +150., ?i?m h?i k? n?ng: +15., Hút máu toàn ph?n +15%');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (148,'2020-12-24 13:20',3300,'Rìu Sát Th?n',2500,9,'https://izgaming.com/wp-content/uploads/2020/11/riu-sat-than.jpg','Thu?c tính: S?c m?nh công kích: +40., Máu: +400., ?i?m h?i k? n?ng: +20.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (149,'2020-12-24 13:20',3333,'Tam H?p Ki?m',2500,9,'https://izgaming.com/wp-content/uploads/2020/11/tam-hop-kiem.jpg','Thu?c tính: S?c m?nh công kích: +35., Máu: +200., T?c ?ánh: +35%., ?i?m h?i k? n?ng: +10');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (150,'2020-12-24 13:20',2700,'Trát L?nh ?? V??ng',2500,9,'https://izgaming.com/wp-content/uploads/2020/11/trach-lenh-de-vuong.jpg','Thu?c tính: Máu: +200., Sát th??ng phép: +40., ?i?m h?i k? n?ng: +20., H?i mana: +100%.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (151,'2020-12-24 13:20',2700,'Tráng ca Shurelya',2500,9,'https://izgaming.com/wp-content/uploads/2020/11/trang-ca-shurelya.jpg','Thu?c tính: T?c ?? di chuy?n: +5%., Máu: +350., ?i?m h?i k? n?ng: +20., N?ng l??ng h?i ph?c: +50%.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (152,'2020-12-24 13:20',2700,'M?t n? v?c th?m',2500,10,'https://izgaming.com/wp-content/uploads/2020/03/M%E1%BA%B7t-n%E1%BA%A1-v%E1%BB%B1c-th%E1%BA%B3m.png','Phá H?y: Làm B?t ??ng t??ng ??ch s? khi?n chúng ch?u thêm 10% sát th??ng trong 4 giây.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (153,'2020-12-24 13:20',3000,'Quy?n tr??ng thiên th?n',2500,10,'https://izgaming.com/wp-content/uploads/2020/11/quyen-truong-thien-than.pngg','Tuy?t: Nh?n thêm S?c m?nh Phép thu?t t??ng ???ng v?i 3% N?ng l??ng c?ng thêm.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (154,'2020-12-24 13:20',2300,'L? H??ng Sôi S?c',2500,10,'https://izgaming.com/wp-content/uploads/2020/12/lu-huong-soi-suc.png','C?u Nguy?n: H?i Máu ho?c t?o Lá ch?n cho ??ng minh s? c??ng hóa c? hai trong 6 giây, cho các ?òn ?ánh thêm 10% – 30% (d?a trên c?p c?a ??ng minh) T?c ?? ?ánh và 5 – 20 (d?a trên c?p c?a ??ng minh) sát th??ng phép.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (155,'2020-12-24 13:20',2600,'banshee’s Veil',2500,10,'https://izgaming.com/wp-content/uploads/2021/01/banshees-Veil.jpg','Thu?c tính: T?o m?t lá ch?n phép thu?t ch?n kh? n?ng thù ??ch ti?p theo (40 (kh?i ??ng l?i sau khi nh?n sát th??ng t? t??ng) th?i gian h?i chiêu th? hai).');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (156,'2020-12-24 13:20',3300,'Rìu ?en',2500,10,'https://izgaming.com/wp-content/uploads/2020/03/R%C3%ACu-%C4%91en.png','Nghi?n V?n: Gây sát th??ng v?t lý lên m?t t??ng s? khi?n chúng ch?u c?ng d?n gi?m 4% Giáp trong 6 giây (t?i ?a gi?m 24% Giáp.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (157,'2020-12-24 13:20',400,'L??i hái s??ng ?en',2500,10,'https://izgaming.com/wp-content/uploads/2021/01/luoi-hai-suong-den.jpg','KÍCH HO?T DUY NH?T C?M M?T: C?m xu?ng m?t M?t Xanh. S? h?u t?i ?a 4 tích tr?, s? ???c s?c l?i m?i khi quay v? c?a hàng.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (158,'2020-12-24 13:20',3200,'G??m c?a vua vô danh',2500,10,'https://izgaming.com/wp-content/uploads/2020/12/guom-cua-vua-vo-danh.png','L??i G??m Suy Vong: Các gây thêm sát th??ng v?t lý t??ng ???ng v?i (10% v?i t??ng C?n Chi?n | 6% v?i t??ng ?ánh Xa) Máu hi?n t?i c?a m?c tiêu.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (159,'2020-12-24 13:20',3400,'Huy?t ki?m',2500,10,'https://izgaming.com/wp-content/uploads/2020/11/huyet-kiem.png','Khiên Máu:Hút Máu t? ?òn ?ánh có th? h?i máu ph? tr?i. L??ng Máu d? này ???c tích tr? thành 50 – 350 (d?a trên c?p ??) Lá ch?n, s? gi?m d?n theo th?i gian n?u nh? không gây ho?c nh?n sát th??ng trong vòng 25 giây.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (160,'2020-12-24 13:20',400,'bulwark of the mountain',2500,10,'https://izgaming.com/wp-content/uploads/2021/01/bulwark-of-the-mountain.jpg','Tiêu t?n m?t kho?n phí ?? ??t M?t tàng hình t?i v? trí m?c tiêu, cho phép quan sát khu v?c xung quanh. N?p l?i phí khi ghé th?m c?a hàng (4 l?n s?c; ph?m vi 600).');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (161,'2020-12-24 13:20',2100,'chemtech putrifier',2500,10,'https://izgaming.com/wp-content/uploads/2021/01/chemtech-putrifier.jpg','Thu?c tính: Gây sát th??ng lên t??ng ??ch khi?n chúng b? V?t Th??ng Sâu trong 3 giây.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (163,'2020-12-24 13:20',2900,'Giáp Li?t S?',2500,10,'https://izgaming.com/wp-content/uploads/2020/11/giap-liet-si.png','Nh?p ?? ?áy Sâu: Khi di chuy?n, nh?n thêm t?i ?a 60 T?c ?? Di chuy?n. N?u ?òn ?ánh ???c tung ra b?i t??ng C?n Chi?n lúc t?i ?a t?c ??, nó s? Làm Ch?m m?c tiêu ?i 50% trong 1 giây.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (164,'2020-12-24 13:20',3100,'V? ?i?u t? th?n',2500,10,'https://izgaming.com/wp-content/uploads/2020/03/V%C5%A9-%C4%91i%E1%BB%87u-t%E1%BB%AD-th%E1%BA%A7n.png','Ch?u ?òn: 35% (15% v?i t??ng ?ánh Xa) l??ng sát th??ng v?t lý b?n gánh ch?u s? gây theo d?ng sát th??ng th?i gian trong 3 giây.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (165,'2020-12-24 13:20',2900,'Áo choàng bóng t?i',2500,10,'https://izgaming.com/wp-content/uploads/2020/11/ao-choang-bong-toi.png','Tiêu Tr?: Nh?n m?t Khiên Phép ch?n K? n?ng ti?p theo c?a k? ??ch (h?i l?i sau 40 giây).');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (166,'2020-12-24 13:20',2900,'L??i hái linh h?n',2500,10,'https://izgaming.com/wp-content/uploads/2020/12/luoi-hai-linh-hon.png','Ki?m Phép: Sau khi s? d?ng m?t K? n?ng, ?òn ?ánh ti?p theo c?a b?n gây thêm (100% S?c m?nh Công kích c? b?n + 40% S?c m?nh Công kích c?ng thêm) sát th??ng v?t lý và h?i l?i 3% N?ng l??ng t?i ?a (h?i l?i sau 1.5 giây).');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (167,'2020-12-24 13:20',2700,'Tim b?ng',2500,10,'https://izgaming.com/wp-content/uploads/2020/11/tim-bang.png','Chi?n Binh Mùa ?ông: Gi?m T?c ?? ?ánh c?a k? ??ch xung quanh ?i 15%.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (168,'2020-12-24 13:20',3300,'Thú t??ng th?ch giáp',2500,10,'https://izgaming.com/wp-content/uploads/2020/11/thu-tuong-thach-giap.png','Kích ho?t – B?t Ho?i: Nh?n (100 + 100% Máu c?ng thêm) Lá ch?n gi?m d?n và t?ng kích c? lên 25% trong 2.5 giây. (h?i l?i sau 90 giây).');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (169,'2020-12-24 13:20',3400,'Giáp thiên th?n',2500,10,'https://izgaming.com/wp-content/uploads/2020/12/giap-thien-than.png','C?u R?i: Khi nh?n sát th??ng và b? h? g?c, h?i l?i 50% Máu c? b?n và 30% N?ng l??ng t?i ?a sau 4 giây ? tr?ng thái ng?ng ??ng (h?i l?i sau 300 giây).');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (170,'2020-12-24 13:20',2800,'Cu?ng ?ao Guinsoo',2500,10,'https://izgaming.com/wp-content/uploads/2020/12/cuong-dao-guinsoo.jpg','Ph?n N?: T? l? Chí m?ng c?a b?n s? chuy?n hóa thành sát th??ng ?òn ?ánh. Các ?òn ?ánh s? gây thêm 40 v?i m?i 20% T? l? Chí m?ng chuy?n hóa ???c.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (171,'2020-12-24 13:20',3400,'Vô c?c ki?m',2500,10,'https://izgaming.com/wp-content/uploads/2020/12/vo-cuc-kiem.png','Hoàn M?: N?u b?n có ít nh?t 60% T? l? Chí m?ng, b?n s? nh?n thêm 35% Sát th??ng Chí m?ng.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (172,'2020-12-24 13:20',2300,'L?i th? hi?p s?',2500,10,'https://izgaming.com/wp-content/uploads/2020/03/L%E1%BB%9Di-th%E1%BB%81-hi%E1%BB%87p-s%C4%A9.png','Kích ho?t – Cam K?t: Ch? ??nh m?t ??ng minh là ng??i X?ng ?áng (h?i l?i sau 60 giây).');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (173,'2020-12-24 13:20',3000,'Ki?m tai ??ng',2500,10,'https://izgaming.com/wp-content/uploads/2020/11/kiem-tai-uong.png','+80 S?c m?nh phép thu?t, 10% T?c ?? di chuy?n.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (174,'2020-12-24 13:20',2900,'N? th?n Dominik',2500,10,'https://izgaming.com/wp-content/uploads/2020/12/no-than-dominik.png','Di?t Kh?ng L?: Gây thêm t?i ?a 15% sát th??ng v?t lý lên t??ng có Máu t?i ?a l?n h?n b?n.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (175,'2020-12-24 13:20',2600,'Ki?m Manamune',2500,10,'https://izgaming.com/wp-content/uploads/2020/11/kiem-manamune.png','Tuy?t: Nh?n thêm S?c m?nh Công kích t??ng ???ng v?i 2% N?ng l??ng t?i ?a');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (176,'2020-12-24 13:20',3100,'Chùy gai Malmortius',2500,10,'https://izgaming.com/wp-content/uploads/2020/11/chuy-gai-malmortius.png','Thu?c tính: 50 Sát th??ng v?t lý, 50 Kháng phép, 15 ?i?m h?i k? n?ng');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (177,'2020-12-24 13:20',1600,'Sách chiêu h?n Mejai',2500,10,'https://izgaming.com/wp-content/uploads/2020/11/sach-chieu-hon-mejai.png','Vinh Quang: Nh?n 4 c?ng d?n khi h? g?c t??ng ho?c 2 c?ng d?n khi h? tr? h? g?c (t?ng s? c?ng d?n t?i ?a là 25). M?t 10 c?ng d?n khi b? h? g?c.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (178,'2020-12-24 13:20',3000,'?ao th?y ngân',2500,10,'https://izgaming.com/wp-content/uploads/2021/01/mercurial-scimitar.jpg','Lo?i b? t?t c? các l?i kh?ng ch? ?ám ?ông (ngo?i tr? Dù) kh?i t??ng c?a b?n và t?ng thêm 50% t?ng t?c ?? di chuy?n và bóng ma trong 1,5 giây (th?i gian h?i chiêu là 90 giây).');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (179,'2020-12-24 13:20',2300,'mikael’s blessing',2500,10,'https://izgaming.com/wp-content/uploads/2021/01/mikaels-blessing.jpg','Lo?i b? t?t c? các debuff ki?m soát ?ám ?ông kh?i b?n thân ho?c t??ng ??ng minh m?c tiêu và h?i máu cho m?c tiêu trong 100 ? 250 (120 giây h?i chiêu; t?m 650).');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (180,'2020-12-24 13:20',3000,'Qu? th? Morello',2500,10,'https://izgaming.com/wp-content/uploads/2020/12/quy-thu-morello.png','Tai H?a: Gây sát th??ng phép s? áp d?ng 40% V?t Th??ng Sâu lên t??ng ??ch trong 2 giây. N?u m?c tiêu d??i 50% Máu, hi?u ?ng này ???c t?ng lên 60% V?t Th??ng Sâu.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (181,'2020-12-24 13:20',2500,'L?i nh?c t? vong',2500,10,'https://izgaming.com/wp-content/uploads/2020/12/loi-nhac-tu-vong.png','Nhi?m Trùng: Gây sát th??ng v?t lý s? áp d?ng 40% V?t Th??ng Sâu lên t??ng ??ch trong 2 giây.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (182,'2020-12-24 13:20',2900,'Muramana',2500,10,'https://izgaming.com/wp-content/uploads/2021/01/muramana.jpg','Các ?òn t?n công c? b?n lên t??ng ??ch gây thêm 1,5% sát th??ng v?t lý n?ng l??ng t?i ?a.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (183,'2020-12-24 13:20',3000,'Nanh Nashor',2500,10,'https://izgaming.com/wp-content/uploads/2020/12/nanh-nashor.png','V?t C?n Icathia: Các gây thêm (15 + 20% S?c m?nh Phép thu?t) sát th??ng phép ?òn ?ánh.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (184,'2020-12-24 13:20',400,'Giáp b?ch ng?c',2500,10,'https://izgaming.com/wp-content/uploads/2020/11/giap-bach-ngoc.png','C?m xu?ng m?t M?t Xanh. S? h?u t?i ?a 4 tích tr?, s? ???c s?c l?i m?i khi quay v? c?a hàng.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (185,'2020-12-24 13:20',2500,'Ma v? song ki?m',2500,10,'https://izgaming.com/wp-content/uploads/2020/03/Ma-v%C5%A9-song-ki%E1%BA%BFm.png','Ma V?: T?n công s? cho hi?u ?ng Bóng M? và 7% T?c ?? Di chuy?n trong 3 giây. ');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (186,'2020-12-24 13:20',3800,'M? Phù Thu? Rabadon',2500,10,'https://izgaming.com/wp-content/uploads/2020/12/mu-phu-thuy-rabadon.png','Tinh hoa phép thu?t: T?ng t?ng s?c m?nh phép thu?t c?a b?n lên 35%.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (187,'2020-12-24 13:20',2700,'Khiên b?ng Randuin',2500,10,'https://izgaming.com/wp-content/uploads/2020/11/khien-bang-randuin.png','Ch?n ??ng: Thoáng ch?c Làm Ch?m k? ??ch ? g?n và gi?m S?c m?nh Công kích c?a chúng ?i 10%, Sát th??ng Chí m?ng ?i 20% trong 4 giây');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (188,'2020-12-24 13:20',2500,'??i bác liên thanh',2500,10,'https://izgaming.com/wp-content/uploads/2020/12/dai-bac-lien-thanh.jpg','Tích ?i?n: Di chuy?n và T?n công s? tích t? m?t ?òn ?ánh Tích ?i?n.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (189,'2020-12-24 13:20',3300,'Rìu mãng xà',2500,10,'https://izgaming.com/wp-content/uploads/2020/03/R%C3%ACu-M%C3%A3ng-X%C3%A0.png','Sát Th??ng Lan: ?òn ?ánh và K? n?ng gây t?i ?a (60% S?c m?nh Công kích) sát th??ng v?t lý lên nh?ng k? ??ch ? g?n m?c tiêu ??u tiên trúng ph?i.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (190,'2020-12-24 13:20',2300,'Dây chuy?n chu?c t?i',2500,10,'https://izgaming.com/wp-content/uploads/2020/11/day-chuyen-chuoc-toi.png','Thu?c tính: 20% Hi?u l?c h?i máu và lá ch?n, 200 Máu, 15 ?i?m h?i máu, 100% T?c ?? h?i n?ng l??ng c? b?n');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (191,'2020-12-24 13:20',3400,'Cu?ng cung Runaan',2500,10,'https://izgaming.com/wp-content/uploads/2020/12/cuong-cung-runaan.png','Gió Cu?ng N?: Khi T?n công, b?n ra các tia ??n vào t?i ?a 2 k? ??ch g?n m?c tiêu, m?i tia gây (40-70% () S?c m?nh Công kích) sát th??ng v?t lý.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (192,'2020-12-24 13:20',3000,'Tr??ng pha lê Rylai',2500,10,'https://izgaming.com/wp-content/uploads/2020/11/truong-pha-le-rylai.png','Bu?t Giá: K? n?ng Sát th??ng s? Làm Ch?m k? ??ch ?i 30% trong 1 giây.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (193,'2020-12-24 13:20',3000,'Huy?t ?ao',2500,10,'https://izgaming.com/wp-content/uploads/2020/03/Huy%E1%BA%BFt-%C4%91ao.png','?iên Cu?ng: Khi có m?t ho?c ít h?n t??ng ??ch nhìn th?y ???c g?n ?ó, nh?n 8 Sát L?c và 20% – 80% T?c ?? ?ánh, gi?m d?n trong 3 giây n?u nh?ng t??ng ??ch khác ??n g?n.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (194,'2020-12-24 13:20',2100,'Quy?n tr??ng ??i thiên s?',2500,10,'https://izgaming.com/wp-content/uploads/2020/12/quyen-truong-dai-thien-su.png','N?i t?i DUY NH?T: Nh?n s?c m?nh phép thu?t b?ng 5 % n?ng l??ng t?i ?a.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (195,'2020-12-24 13:20',400,'M?nh chân b?ng',2500,10,'https://izgaming.com/wp-content/uploads/2020/11/manh-chan-bang.png','N?i t?i DUY NH?T: Nh?n l??ng vàng gi?m d?n khi tiêu di?t quá nhi?u lính.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (196,'2020-12-24 13:20',2900,'Giáp tâm linh',2500,10,'https://izgaming.com/wp-content/uploads/2020/05/giap-tam-linh.jpg','Ngu?n S?ng B?t T?n: T?ng hi?u qu? kh? n?ng H?i máu và t?o Lá ch?n trên b?n lên 25%.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (197,'2020-12-24 13:20',2300,'Tr??ng l?u thu?',2500,10,'https://izgaming.com/wp-content/uploads/2020/12/truong-luu-thuy.png','N??c S?i B?t: H?i Máu ho?c t?o Lá ch?n cho m?t ??ng minh t?ng cho c? hai 15% T?c ?? Di chuy?n và AP>20 – 40 ( c?a ??ng minh) S?c m?nh Phép thu?t trong 3 giây.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (198,'2020-12-24 13:20',3100,'Móng Vu?t Sterak',2500,10,'https://izgaming.com/wp-content/uploads/2020/03/M%C3%B3ng-Vu%E1%BB%91t-Sterak.png','Cu?ng N?: Gây ho?c nh?n sát th??ng t? t??ng s? nh?n c?ng d?n, h?i l?i (2% Máu t?i ?a | 1.2% Máu t?i ?a v?i t??ng ?ánh Xa) trong 6 giây.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (199,'2020-12-24 13:20',2700,'Phong th?n ki?m',2500,10,'https://izgaming.com/wp-content/uploads/2020/03/Phong-Th%E1%BA%A7n-Ki%E1%BA%BFm.png','Tích ?i?n: Di chuy?n và T?n công s? tích t? m?t ?òn ?ánh Tích ?i?n.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (200,'2020-12-24 13:20',2350,'Giáp gai',2500,10,'https://izgaming.com/wp-content/uploads/2020/11/giap-gai.png','Khi b? t?n công b?i các ?òn ?ánh th??ng, thì s? ph?n l?i 10 (+ 10% giáp c?ng thêm ) sát th??ng phép cho k? t?n công và n?u h? là t??ng ??ng th?i t??ng ?ó s? nh?n thêm 40% V?t th??ng sau trong 3s.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (201,'2020-12-24 13:20',2600,'Ki?m âm u',2500,10,'https://izgaming.com/wp-content/uploads/2020/03/Ki%E1%BA%BFm-%C3%82m-U.png','Khi b? phát hi?n b?i ph??ng ho?c b?y c?a ??i ph??ng, nh?n H?c Ám trong bán kính 400 ??n v? trong 8 giây ( 45 giây h?i chiêu)');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (202,'2020-12-24 13:20',3300,'Rìu ??i mãng xà',2500,10,'https://izgaming.com/wp-content/uploads/2020/03/R%C3%ACu-%C4%91%E1%BA%A1i-m%C3%A3ng-x%C3%A0.png','??i Xà: Nh?n thêm S?c m?nh Công kích t??ng ???ng 1% Máu t?i ?a.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (203,'2020-12-24 13:20',2300,'?á to? sáng b?o h?',2500,10,'https://izgaming.com/wp-content/uploads/2020/12/dao-toa-sang-bao-ho.png','V?t ph?m này có th? l?u tr? t?i ?a 3 Th? ?i?u Khi?n ?ã mua.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (204,'2020-12-24 13:20',2500,'Tr??ng h? vô',2500,10,'https://izgaming.com/wp-content/uploads/2020/11/truong-hu-vo.png','Thu?c tính: 65 S?c m?nh phép thu?t, 40% Xuyên Giáp');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (205,'2020-12-24 13:20',3000,'Giáp máu Warmog',2500,10,'https://izgaming.com/wp-content/uploads/2020/11/giap-mau-warmog.png','Trái Tim Warmog: N?u có ít nh?t 3000 Máu t?i ?a, h?i l?i 5% Máu t?i ?a m?i giây sau 6 giây không ph?i ch?u sát th??ng');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (206,'2020-12-24 13:20',3100,'?ao tím',2500,10,'https://izgaming.com/wp-content/uploads/2021/01/wits-End.jpg','?òn ?ánh c? b?n gây thêm 15 – 80 sát th??ng phép khi trúng ?ích (tùy theo c?p ??) và cho b?n thêm 20 t?c ?? di chuy?n trong 2 giây.');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (207,'2020-12-24 13:20',2400,'T? bão Zeke',2500,10,'https://izgaming.com/wp-content/uploads/2020/11/tu-bao-zeke.png','Kích ho?t D?n Truy?n: Ch? ??nh m?t ??i Tác (h?i l?i sau 60 giây).');
Insert into LN_PRODUCTS (PRODUCT_ID,CREATE_DATE,PRICE,PRODUCT_NAME,QUANTITY,CATEGORY_ID,IMAGES,DESCRIBE) values (208,'2020-12-24 13:20',2500,'??ng h? cát Zhonya',2500,10,'https://izgaming.com/wp-content/uploads/2020/12/dong-ho-cat-zhonya.png','Kích ho?t – Ng?ng ??ng: B?n tr? nên B?t T? và Không Th? Ch? ??nh trong 2.5 giây, nh?ng s? b?t ??ng trong th?i gian này (h?i l?i sau 120 giây).');
